...
## We will now see the effectiveness of "alcohol" content data in classifying the "wine_quality" into 
...
rocobj <- plot.roc(data$wine_quality, data$alcohol,             # data vectors       
                   ...
                   percent=TRUE,                          # TRUE plots in percentages, FALSE for fractions
...
## Compute confidence intervals of Sensitivities at various specificities.
...
## print the confidence intervals of sensitivity at various specificities
print(ciobj)
